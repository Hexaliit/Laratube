            ...
            <section class="about section" id="testimonial">
                <div class="about_container">
                    <div class="titlebar">
                        ...
                        <div class="titlebar_item">
                            <div class="btn btn-secondary" @click="this.updateTestimonial">
                                Update Testimonial
                            </div>
                        </div>
                    </div>
                    <div class="card_wrapper">
                        <div class="wrapper_left">
                            <div class="card">
                                ...
                                <p>Function</p>
                                <input type="text" class="input" v-model="this.form.function"/>

                                <p>Testimony</p>
                                <textarea cols="10" rows="5"  v-model="this.form.testimony"></textarea>
                        ...
                        <div class="wrapper_right ">
                            <div class="card">
                                ...
                                <br>
                                <p>Rating ?/5</p>
                                <input type="text" class="input" v-model="this.form.rating"/>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods : {
            getTestimonial : function(){
                axios.get('/api/get_testimonial/'+this.id)
                    .then(response => {
                        this.form = response.data.testimonial;
                    })
            ...
            updateTestimonial : function () {
                axios.post(`/api/update_testimonial/${this.form.id}` , this.form)
                    .then(response => {
